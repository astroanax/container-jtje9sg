...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jtje9sg.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jtje9sg.containers.anotherwebservice.com/
...
```
git clone git@github.com:astroanax/container-jtje9sg.git
cd container-jtje9sg
```
...
```
docker attach container-jtje9sg
```
